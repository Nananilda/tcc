    ...
    <form method="POST" action="/tcc/app/controllers/UsuarioController.php" autocomplete="off" id="formCadastro">
        ...
        <fieldset>
            ...
            <label>Nome Completo *<br>
                <input type="text" name="nome" maxlength="100" placeholder="Ex: João da Silva"
                    value="<?php echo htmlspecialchars($dados['nome'], ENT_QUOTES, 'UTF-8'); ?>" required>
            </label><br><br>

            <label>Login *<br>
                <input type="text" name="login" maxlength="50" placeholder="joao.silva"
                    value="<?php echo htmlspecialchars($dados['login'], ENT_QUOTES, 'UTF-8'); ?>"
                    pattern="[a-zA-Z0-9._\-]{3,50}"
                    title="Apenas letras, números, ponto, hífen ou underscore (3–50 chars)" required id="campo_login">
        ...
        <fieldset>
            ...
            <label>Senha * (mín. 8 chars, maiúscula, número e especial)<br>
                <input type="password" name="senha" id="campo_senha" maxlength="128" placeholder="Mín. 8 chars"
                    required>
                <span id="forca_senha" style="font-size:0.85em;"></span>
            </label><br><br>

            <label>Confirmar Senha *<br>
                <input type="password" name="confirmar" id="campo_confirmar" maxlength="128"
        ...
        <fieldset>
            ...
            <label>Tipo de Usuário *<br>
                <select name="tipo" required>
                    <option value="usuario" <?php echo $dados['tipo'] === 'usuario' ? 'selected' : ''; ?>>Funcionário
                    </option>
                    <option value="admin" <?php echo $dados['tipo'] === 'admin' ? 'selected' : ''; ?>>Administrador
                    </option>
                </select>
            </label><br><br>
            ...
            <label>Status da Conta *<br>
                <select name="status" required>
                    ...
                    <option value="inativo" <?php echo $dados['status'] === 'inativo' ? 'selected' : ''; ?>>Inativo
                    </option>
                </select>
            </label>
        </fieldset>
