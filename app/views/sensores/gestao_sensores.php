            ...
            <div class="card">
                ...
                <form method="POST" class="sensores-form-novo">
                    ...
                    <div>
                        ...
                        <input type="text" name="nome" maxlength="100" required placeholder="Ex: Sensor Galpão A">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="localizacao" maxlength="150" placeholder="Ex: Setor B, linha 3">
                    </div>
